...
export const products: Product[] = [
  ...
  },
  {
    ...
    availability: null,
    sku: null,
    shortDescription: 'Премиальная линейка питьевой воды «Утоли» 19 л.',
    verifiedFacts: [
      { label: 'Объём', value: '19 л' },
      { label: 'Линейка', value: 'Premium' },
      { label: 'Категория', value: 'Природная питьевая вода первой категории' },
      { label: 'Срок годности', value: '24 месяца' },
    ],
    ...
    seo: {
      ...
      description:
        'Премиальная линейка «Утоли» в бутыли 19 л с доставкой по Ухте. Заказ в приложении Utoli или у диспетчера.',
    },
  },
];
