      ...
      <div className="container">
        ...
        <div className={`prose ${styles.body}`}>
          <p>
            ...
            {site.cityPrepositional}, пригородам и в Сосногорск. Заказ можно начать в мобильном
            приложении {site.appName}, через <Link href={routes.catalog.path}>каталог на сайте</Link>{' '}
            или звонком оператору по номеру{' '}
            <a href={site.dispatcherPhoneHref}>{site.dispatcherPhoneDisplay}</a>. На сайте каталог
            ведёт к оформлению в приложении.
          </p>
          ...
          <p>
            ...
            вода премиум-класса с магнием, «{site.brandNameRu} Premium» — вода высшей категории
            очистки с микрочастицами серебра.
          </p>
          ...
          <p>
            ...
            таре уточняйте у оператора — их также опишем на странице{' '}
          ...
          <p>
            ...
            голосом — обсудить количество бутылей, адрес и удобное время можно с оператором по
            телефону.
          </p>
          ...
          <p>
            ...
            объёме. Для организаций порядок работы и оплату проще обсудить с оператором напрямую.
          </p>

          <h3>Куда возим</h3>
          <p>
            Зона доставки — {site.deliveryAreasSummary}. Если ваш адрес рядом с зоной, но в списке
            его нет, спросите оператора: маршрут часто можно согласовать. Подробности собраны на
            странице{' '}
