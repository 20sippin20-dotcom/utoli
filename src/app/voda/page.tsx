        ...
        <div className="container">
          ...
          <div className="prose">
            <p>
              ...
              линейка с микрочастицами серебра (Ag).
            </p>
            <p>
              Документы на продукцию — декларации и протоколы исследований — можно запросить у
              оператора, см. <a href={routes.documents.path}>страницу документов</a>.
            </p>
            <p>
              ...
              <a href={site.dispatcherPhoneHref}>{site.dispatcherPhoneShortDisplay}</a>.
            </p>
          </div>
        </div>
      </section>
