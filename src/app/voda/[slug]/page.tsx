...
function ProductDescription({ slug }: { slug: string }) {
  ...
  if (slug === 'utoli-premium-19l') {
    return (
      <>
        <p>
          «{site.brandNameRu} Premium» — премиальная линейка бренда в бутыли 19 литров, выпускается
          с добавлением ионов серебра. На этикетке она выделена глубоким синим цветом и золотистой
          полосой.
        </p>
        <p>
